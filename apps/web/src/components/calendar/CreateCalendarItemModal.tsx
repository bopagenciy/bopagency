...
export const CreateCalendarItemModal: React.FC<CreateCalendarItemModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/60 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-card text-card-foreground rounded-lg max-w-lg w-full p-6 shadow-2xl border border-border animate-in fade-in zoom-in duration-150">
        <div className="flex items-center justify-between pb-4 border-b border-border">
          <h3 className="text-base font-semibold text-foreground">Programar Nuevo Contenido</h3>
        ...
        <form noValidate onSubmit={handleSubmit} className="py-4 space-y-4 text-xs">
          ...
          <div>
            <label className="block font-medium text-foreground mb-1">ID de Campaña *</label>
            <input
              type="text"
              required
          ...
          <div>
            <label className="block font-medium text-foreground mb-1">Título del Contenido *</label>
            <input
              type="text"
              required
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block font-medium text-foreground mb-1">Canal *</label>
              <select
                value={channel}
            ...
            <div>
              <label className="block font-medium text-foreground mb-1">Proveedor *</label>
              <select
                value={provider}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label htmlFor="create-scheduled-date" className="block font-medium text-foreground mb-1">Fecha *</label>
              <input
            ...
            <div>
              <label className="block font-medium text-foreground mb-1">Hora (UTC) *</label>
              <input
                type="time"
                required
          ...
          <div>
            <label className="block font-medium text-foreground mb-1">Resumen del Contenido</label>
            <textarea
              rows={3}
          ...
          <div>
            <label className="block font-medium text-foreground mb-1">Notas Internas</label>
            <textarea
              rows={2}
              value={notes}
