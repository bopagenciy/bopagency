...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      pending_google_oauth_credentials: {
        Row: {
          id: string;
          pending_connection_id: string;
          key_version: number;
      ...
      pending_google_oauth_resources: {
        Row: {
          id: string;
          pending_connection_id: string;
          customer_id: string;
      ...
      campaign_provider_observations: {
        Row: {
          id: string;
          organization_id: string;
          client_id: string;
          ...
          previous_resource_status: string | null;
          metadata: Json;
          created_at: string;
        };
        Insert: {
